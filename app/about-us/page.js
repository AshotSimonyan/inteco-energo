          ...
          <div className='about-wrapper row'>
            ...
            <div className='col-lg-6 col-12 order-3 order-lg-1'>
              <div className='about-content about-content-1'>
                <h1>Մեր մասին</h1>
                <p>
                  «Ինտեկո Էներգո» ՓԲԸ-ն հիմնադրվել է 2017թ մարտ ամսին և հանդիսանում է Հայաստանում
                  գործող խոշորագույն շինարարական ընկերություններից մեկը։ Մենք իրականացնում ենք
                  բազմաբնույթ շինարարական աշխատանքներ բնակելի, հասարակական և էներգետիկ ոլորտում։
                  Տևական ժամանակ, հանդիսանալով Հայստանի Էլեկտրական Ցանցերի հիմնական կապալառուներից
                  մեկը, մենք իրականացրել ենք ՀՀ-ում և Արցախում էներգետիկ ենթակառուցվածքների
                  կառուցման, վերակառուցման և վերազինման լայնածավալ աշխատանքներ։
                </p>
              </div>
            </div>
              ...
              <div className='about-content about-content-2'>
                ...
                <ul>
                  <li>
                    ...
                    Մենք պարտավորվում ենք ապահովել հուսալի և անխափան էլեկտրամատակարարում մեր
                    հաճախորդների համար:
                  </li>
                  <li>
