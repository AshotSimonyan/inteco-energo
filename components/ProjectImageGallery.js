                ...
                <div className='row'>
                  <div className='col-md-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-13.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
                      <div className='single-gallery-project__content'>
                        ...
                        <Link href='/project-details'>SEE MORE</Link>
                      </div>
                    </div>
                  </div>
                  <div className='col-md-3 col-mobile-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-14.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
                  ...
                  <div className='col-md-3 col-mobile-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-15.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
                  ...
                  <div className='col-md-3 col-mobile-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-16.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
                  ...
                  <div className='col-md-3 col-mobile-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-17.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
                  ...
                  <div className='col-md-6'>
                    <div className='single-gallery-project'>
                      <div className='single-gallery-project__image'>
                        <img
                          src='/public/assets/img/projects/project-18.jpg'
                          className='img-fluid'
                          alt=''
                        />
                      </div>
