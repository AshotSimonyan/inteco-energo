...
const ProjectSlider = () => {
  ...
  const data = [
    {
      img: '1.jpg',
      sliderTitle: 'Construction Management',
      sliderShortDesc:
        ...
        <div className='row row-30 align-items-center'>
          ...
          <div className='col-lg-6'>
            <div className='content'>
              ...
              <Link href={`/${val.sliderLink}`} className='see-more-link see-more-link--color'>
                VIEW MORE
              </Link>
            </div>
          </div>
